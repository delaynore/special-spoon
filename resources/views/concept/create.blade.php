                ...
                <form method="post" action="{{route('concept.store', $dictionary)}}">
                    ...
                    <div class="grid gap-4 mb-4">
                        ...
                        <div class="sm:col-span-2">
                            <label for="definition" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Определение')}}</label>
                            <textarea id="definition" name="definition" value="{{old('definition')}}" rows="4" class="block p-2.5 w-full min-h-12 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="{{__('Определение понятия')}}" maxlength="1000" required></textarea>
