...
<x-layout.main>
    ...
    <section class="flex w-full items-start mb-4">
            ...
            <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                ...
                <div class="overflow-x-auto">
                    ...
                    <div class="px-4">
                        ...
                        <a data-route="{{route('dictionary.show', $dictionary->id)}}" class="dictionary-card flex justify-end my-2 items-center bg-white border border-gray-200 rounded-lg shadow py-2 px-4 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <div class="flex flex-col justify-between leading-normal flex-1 me-4">
                                @if (Auth::check() && Auth::user()->id === $dictionary->user->id)
                                <p class="mt-1 bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300 w-fit">{{__('Ваш')}}</p>
                                @else
                            ...
                            <div class="flex justify-center items-center flex-col">
                                <button id="{{$dictionary->id}}-button" data-dropdown-toggle="{{$dictionary->id}}" class="h-full inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                    <svg class="w-6 h-6 rotate-90 active:rotate-180 transition-all" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
