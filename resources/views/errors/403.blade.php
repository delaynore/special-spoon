    ...
    <section class="flex justify-center w-full bg-white dark:bg-gray-900">
        <div class="container flex items-center justify-center">
            <div class="flex flex-col items-center max-w-sm mx-auto text-center">
                ...
                <h1 class="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">{{ __('error.403.title')}}</h1>
                <p class="mt-4 text-gray-500 dark:text-gray-400">{{ __('error.403.message') }}</p>
